...
using static Softpower.SmartMaker.TopSmartAtomEdit.SubControls.QuizViewOption.QuizViewOption_A21;

namespace Softpower.SmartMaker.TopSmartAtomEdit.SubControls.QuizViewOption
{
	/// <summary>
	/// QuizViewOption_A25 : 선긋기 (평가형) 옵션창
	/// </summary>
	public partial class QuizViewOption_A25 : Grid
	{
		...
		{
			get { return _Kiss.toInt32 (VerticalOffsetBox.Text); }
			set { VerticalOffsetBox.Text = value.ToString (); }
		}

		public QuizViewOption_A25 ()
		{
			InitializeComponent ();
			DataContext = this;
			InItStyle ();
